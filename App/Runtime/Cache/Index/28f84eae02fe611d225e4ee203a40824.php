...
<div class="max">
	<div class="nav-scroller btnSwiper" style="">
	  <nav class="nav d-flex justify-content-between">
	   <a <?php if($id == null): ?>class="hongse"<?php endif; ?> href="<?php echo U('lists');?>"> 全部项目   </a>
	   <?php if(is_array($project_class)): $i = 0; $__LIST__ = $project_class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$i): $mod = ($i % 2 );++$i;?><a <?php if($id == $i['id']): ?>class="hongse"<?php endif; ?> href="<?php echo U('lists','id='.$i['id']);?>"><?php echo ($i['name']); ?> </a><?php endforeach; endif; else: echo "" ;endif; ?>
 ...
 <script type="text/javascript" src="/Public/m/p/js/rem_002.js"></script> 
  ...
  <div style="height:1rem;"></div>
   <footer class="footer"> 
    <a href="/mobile/index.html"><img src="/Public/m/p/img/rbtn_home_hot_normal.png"></a> 
    <a href="/mobile/lists.html"><img src="/Public/m/p/img/288.png"></a> 
    <a href="/user/person.html"><img src="/Public/m/p/img/19.png"></a> 
     <a href="<?php echo getInfo('service');?>"><img src="/Public/m/p/img/18.png"></a> 
   </footer> 
  ...
  <section class="goodsList">
        ...
        <ul class="goodsListGoods">
        	  ...
        	  <?php if(is_array($item)): $i = 0; $__LIST__ = $item;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$i): $mod = ($i % 2 );++$i;?><li href="<?php echo U('details','id='.$i['id']);?>" link="dianji">
            	
                <div>
		<!-- 		|iconv_substr=0,8 -->
                    <h3 style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">PIPE：<?php echo ($i["title"]); ?></h3>
                    <h3 ><?php echo ($i["day"]); ?>个自然日</h3>
                    <h3><?php echo round($i['rate'],2);?>%</h3>
                </div>
                <div>
                    <div>
					<div style="width: 65%;">
                            <div style="float:left">
                                <span style="width: <?php echo round(getProjectPercent($i['id']),2);?>%;"></span>
                            </div>
                        </div>
                        <h3 style="font-weight:normal;font-size:14px;width:35%;float:right"><?php echo floatval($i['total']);?>万</h3>
                        
                    </div>
                    <div>满仓即止</div>
                    <div>起投:<span><?php echo round($i['min'],2);?></span></div>
                </div>
