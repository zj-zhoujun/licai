...
<head>
    ...
    <title>充值记录 -8ye.net 八爷资源网</title>
...
<div class="mobile">
    <div class="othertop">
        ...
        <div class="othertop-font">充值记录</div>
    </div>
    ...
    <div class="record_outer">
    	<table>
            ...
            <?php if(is_array($recharge)): $i = 0; $__LIST__ = $recharge;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($r["money"]); ?></td>
                    <td><?php echo ($r["type"]); ?></td>
                    <td><?php echo ($r["time"]); ?></td>
                    <td>
                        <?php if($r['status'] == 0): ?>处理中<?php endif; ?>
                        <?php if($r['status'] == 1): ?>充值成功<?php endif; ?>
                        <?php if($r['status'] == 2): ?>充值失败<?php endif; ?>
                    </td>
