            ...
            <div class="list_main">
                <table>
                    <tbody>
                        ...
                        <?php $_result=getData('invest_list','all','iid='.$iid,'','id');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$i): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($i["id"]); ?></td>
                            <td><?php echo ($i["title"]); ?></td>
                            <td><?php echo ($i["uid"]); ?></td>
                            <td><?php echo getUserPhone($i['uid']);?></td>
                            <td><?php echo ($i["time1"]); ?></td>
                            <td><?php if($i['time2'] != '0000-00-00 00:00:00'): echo ($i["time2"]); else: ?>未返款<?php endif; ?></td>
                            <td><?php echo ($i["pay1"]); ?></td>
