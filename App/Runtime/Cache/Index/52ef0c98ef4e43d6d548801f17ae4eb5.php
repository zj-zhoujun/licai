...
<head>
    ...
    <title>提现记录 -8ye.net 八爷资源网</title>
...
<div class="mobile">
    ...
    <div class="record_outer">
    	<table>
            ...
            <?php if(is_array($cash)): $i = 0; $__LIST__ = $cash;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($c["money"]); ?></td>
                    <td><?php echo ($c["time"]); ?></td>
                    <td>
                        <?php if($c['status'] == 0): ?>处理中<?php endif; ?>
