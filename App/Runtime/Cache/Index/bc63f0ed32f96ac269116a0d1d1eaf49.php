...
<div class="main">
    ...
    <div class="main_right">
        ...
        <div class="content">
            <form action="<?php echo U('system_contract');?>" method="post" enctype="multipart/form-data">
                <div class="line">
                    <label>图片：<br/><span style="color:#f00;font-size: 12px;">建议尺寸：750x750像素</span></label>
                    <div class="uploads">
                        <img src="/Public/uploads/contract.png?k=<?php echo rand(1,99999);?>" id="portrait">
