...
<div class="main">
    ...
    <div class="main_right">
        ...
        <div class="content">
            <div class="list_main">
	            <div class="title">
	                <form action="<?php echo U('project_class');?>" method="get">
	                    <p>
	                     
                         
                           <a href="<?php echo U('project_class_add');?>" class="two">添加分类</a>
	            ...
	            <table>
	                <tbody>
                        ...
                        <?php $_result=getData('project_class','all',$where,$limit,'sort');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$i): $mod = ($i % 2 );++$i;?><tr>
                          
                                <td><?php echo ($i["id"]); ?></td>
                                 <td><?php echo ($i["name"]); ?></td>
                                   <td><img src="/Public/uploads/item/<?php echo ($i["img2"]); ?>"></td>
                                <td><?php echo ($i["sort"]); ?></td>
                               
                 
                                <td><?php echo (date("Y-m-d H:i:s",$i["add_time"])); ?></td>
                                <td>
                                    <a href="<?php echo U('project_class_edit','id='.$i['id']);?>" class="update">编辑</a>
...
//            window.location.href = "/admin/dellist/data/item/list/"+obj+".html?re=<?php echo U('project_list');?>";
            window.location.href = "<?php echo U('dellist');?>?data=project_class&list="+obj+"&re=<?php echo U('project_class');?>";
        }
    } 
    function delCheck(){ 
        var arr = new Array();
