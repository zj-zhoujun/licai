...
<div class="main">
    ...
    <div class="main_right">
        ...
        <div class="content">
            <div class="list_main">
                <div class="title">
                    <form action="<?php echo U('user_relation');?>" method="get">
                        <p>
                           <label>搜索</label><input type="text" class="txt" name="phone" value="<?php echo ($_GET['phone']); ?>" style="width:200px;" placeholder="会员手机号码">
                           <label>类型</label>
                            <select name="type">
                                <option value="1" <?php if($_GET['type'] == 1): ?>selected="selected"<?php endif; ?>>查看上级</option>
                                <option value="2" <?php if($_GET['type'] == 2): ?>selected="selected"<?php endif; ?>>查看下级</option>
                            </select>
                ...
                <table>
                    <tbody>
                        ...
                        <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><a href="<?php echo U('user_details','id='.$u['id']);?>" target="_blank" class="look">查看详情</a></td>
