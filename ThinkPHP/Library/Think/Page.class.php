...
class Page{
    ...
    private $config  = array(
        'header' => '<span style="margin-left: 10px;">共<b>%TOTAL_ROW%</b>条记录&nbsp;第<b>%NOW_PAGE%</b>页/共<b>%TOTAL_PAGE%</b>页</span>',
        'prev'   => '上一页',
        'next'   => '下一页',
        'first'  => '第一页',
        'last'   => '...%TOTAL_PAGE%',
        'theme'  => '<span>%FIRST%%UP_PAGE%%LINK_PAGE%%DOWN_PAGE%%END%%HEADER%</span>',
    );
