...
) ENGINE=INNODB DEFAULT CHARSET=utf8 COMMENT='用于区分是否已经处理' AUTO_INCREMENT=1 ;");
exit('ok');
 */
...
<head>
    ...
    <title>码支付接口安装 -8ye.net 八爷资源网</title>
    <meta charset="utf-8">
